...
<div class="active-component" id="account-form">
	...
	<div class="info hidden" id="create-form">
		...
		you can shoot me an email and if you prove you are you you can make a new account and I'll copy your stuff to it.
		</div>
	</div>
...
<p>First, the reason that I <span class=”emphasis”>actually</span> wrote it: I wanted to have a good way to 
monitor my progress on things, to keep me motivated and on task. Having a github is okay, but often it doesn't 
really capture what you learned and did. It is common when  writing a program to spend three hours on 
some aspect when the change in code is only a few lines. On github, this shows up as one commit with one minor change, 
but the actual process of arriving at that change is unrepresented; I feel my progress is lost.</p>

<p>I prefer to think of activities and the time spent undertaking that activity, rather than an arbitrary “commit”.</p>

<p>I like the idea that it takes 10,000 hours to master a skill. Thus, a big incentive for me is logging hours. So far, 
it has helped. As of this writing I have about 50 hours of activities logged and I am very eager to hit 100 and then 1,000. </p>
...
<p>But if that was the only idea behind it, it would be called “archivist” and not “cicerone”. A cicerone was a type of person in the Olden days of European grand tours who specialized in the history of a place. They knew what was important about an area and could guide individuals who were on a Grand Tour to the relevant places. Thus, the “Cicerone” portion of the name comes from the “View” feature.</p>
...
<p>I would absolutely love donations. The first things I would spend donation money on are hosting and a nice domain.</p>

<p>In its current iteration, I have no plans for monetizing this app. I have plans for later, but I promise it will never impose on your ability to use cicerone. In fact, I am working on a way of making this “web app” <a href="http://www.gnu.org/philosophy/free-sw.en.html" target="_blank">Free Software</a>. However, for now, it is in a very fragile state, and I would love donations to help ensure I can get it out of this state and into a more self-sustaining model.</p>
